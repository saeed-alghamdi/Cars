...
struct SixthScreenOnBoardView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image("honda").resizable().aspectRatio(contentMode: .fill).ignoresSafeArea()
...
struct SixthScreenOnBoardView_Previews: PreviewProvider {
    static var previews: some View {
        SixthScreenOnBoardView( selection: .constant(5))
    }
}
