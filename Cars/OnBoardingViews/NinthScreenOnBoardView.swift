...
struct NinthScreenOnBoardView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image("gmc").resizable().aspectRatio(contentMode: .fill).ignoresSafeArea()
...
struct NinthScreenOnBoardView_Previews: PreviewProvider {
    static var previews: some View {
        NinthScreenOnBoardView( selection: .constant(8))
    }
}
