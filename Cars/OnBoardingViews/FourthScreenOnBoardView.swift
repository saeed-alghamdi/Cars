...
struct FourthScreenOnBoardView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image("ford").resizable().aspectRatio(contentMode: .fit).ignoresSafeArea()
...
struct FourthScreenOnBoardView_Previews: PreviewProvider {
    static var previews: some View {
        FourthScreenOnBoardView( selection: .constant(3))
    }
}
