...
struct FifthScreenOnBoardView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image("mercedes_logo").resizable().aspectRatio(contentMode: .fit).ignoresSafeArea()
...
struct FifthScreenOnBoardView_Previews: PreviewProvider {
    static var previews: some View {
        FifthScreenOnBoardView( selection: .constant(4))
    }
}
