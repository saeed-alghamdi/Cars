//
//  EighthScreenOnBoardView.swift
//  Cars
//
//  Created by RMP on 25/10/1447 AH.
//

import SwiftUI

struct EighthScreenOnBoardView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image("lamborghini").resizable().aspectRatio(contentMode: .fit).ignoresSafeArea()
...
struct EighthScreenOnBoardView_Previews: PreviewProvider {
    static var previews: some View {
        EighthScreenOnBoardView( selection: .constant(7))
    }
}
