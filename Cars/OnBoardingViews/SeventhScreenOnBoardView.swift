//
//  SeventhScreenOnBoardView.swift
//  Cars
//
//  Created by RMP on 24/10/1447 AH.
//

import SwiftUI

struct SeventhScreenOnBoardView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Image("melaren").resizable().aspectRatio(contentMode: .fit).ignoresSafeArea()
...
struct SeventhScreenOnBoardView_Previews: PreviewProvider {
    static var previews: some View {
        SeventhScreenOnBoardView(selection: .constant(6))
    }
}
